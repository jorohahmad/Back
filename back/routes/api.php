...
Route::middleware('auth:sanctum')->group(function () {
    //
    Route::get('products-for-sale', [ProductController::class, 'indexForSale']);
    Route::get('products-for-rent', [ProductController::class, 'indexForRent']);
    //
    Route::post('password/change', [UserController::class, 'changePassword']);
    //
    Route::post('verification1', [UserController::class, 'Verification1']);
    Route::post('verification2', [UserController::class, 'Verification2']);
    Route::post('verification3', [UserController::class, 'AccountVerification']);
    //
    ...
    //
    Route::get('seller/{seller}/profile', [UserController::class, 'getSellerProfile']);
    Route::get('seller/my-stats', [UserController::class, 'getMyStats']);
    ...
    //
    Route::post('seller/{seller}/rate', [UserController::class, 'rateSeller']);
    //
    Route::post('Cart/add', [CartController::class, 'addToCart']);
    Route::get('Cart/view', [CartController::class, 'viewCart']);
    Route::delete('Cart/delete', [CartController::class, 'deleteFromCart']);
    Route::patch('Cart/update', [CartController::class, 'updateQuantity']);
    Route::post('Cart/checkout', [CartController::class, 'checkout']);
    Route::get('receipts', [CartController::class, 'getUserReceipts']);
    Route::get('receipts/{transaction_id}', [CartController::class, 'getReceiptByTransactionId']);
    //
    Route::post('user/charge', [UserController::class, 'recharge']);
    //
